...
<el-table-column
    ...
    <el-dialog v-model="dialogFormVisible" :show-close="false" width="40%" >
      ...
      <el-form :model="formData" :rules="rules" label-width="80px">
        ...
        <el-form-item label="上级文档" prop="parent_doc" >
          <el-input v-model="formData.parent_doc" autocomplete="off" />
        </el-form-item>
        <el-form-item label="所属文档组" prop="group_id" >
          <el-input v-model="formData.group_id" autocomplete="off" />
        </el-form-item>
        <el-form-item label="排序" prop="sort" >
          <el-input v-model="formData.sort" autocomplete="off" />
        </el-form-item>
        <el-form-item label="编辑器模式" prop="editor_mode" >
          <el-input v-model="formData.editor_mode" autocomplete="off" />
        </el-form-item>
        <el-form-item label="展开下级目录" prop="open_children" >
          <el-input v-model="formData.open_children" autocomplete="off" />
        </el-form-item>
        <el-form-item label="显示下级文档" prop="show_children" >
          <el-input v-model="formData.show_children" autocomplete="off" />
        </el-form-item>
