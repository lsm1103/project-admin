  ...
  <div class="gva-table-box">
    ...
    <el-dialog v-model="dialogFormVisible" :show-close="false" width="40%" >
      ...
      <el-form :model="formData" :rules="rules" label-width="80px">
        ...
        <el-form-item label="主组id" prop="master_group_id" >
          <el-input v-model="formData.master_group_id" autocomplete="off" />
        </el-form-item>
        <el-form-item label="从组id" prop="from_group_id" >
          <el-input v-model="formData.from_group_id" autocomplete="off" />
        </el-form-item>
        <el-form-item label="关系" prop="relation" >
          <el-input v-model="formData.relation" autocomplete="off" />
        </el-form-item>
