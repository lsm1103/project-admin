...
import (
	...
	Application "project-admin/projectBuilds/project10/internal/handler/Application"
	ApplicationConfig "project-admin/projectBuilds/project10/internal/handler/ApplicationConfig"
	Config "project-admin/projectBuilds/project10/internal/handler/Config"
	Doc "project-admin/projectBuilds/project10/internal/handler/Doc"
	DocHistory "project-admin/projectBuilds/project10/internal/handler/DocHistory"
	Group "project-admin/projectBuilds/project10/internal/handler/Group"
	GroupGroupRelation "project-admin/projectBuilds/project10/internal/handler/GroupGroupRelation"
	Project "project-admin/projectBuilds/project10/internal/handler/Project"
	UserGroup "project-admin/projectBuilds/project10/internal/handler/UserGroup"
