...
func (l *GetsLogic) Gets(req *sqlUtils.GetsReq) (resp *types.ApplicationList, err error) {
	// 自动生成的后台管理接口
	resp = &types.ApplicationList{Current: req.Current, PageSize: req.PageSize}
	err = l.svcCtx.ApplicationModel.FindAll(req, &resp.List)
	if err != nil {
		return nil, err
	}
