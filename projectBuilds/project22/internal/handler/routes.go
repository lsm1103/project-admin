...
import (
	...
	Application "project-admin/projectBuilds/project22/internal/handler/Application"
	ApplicationConfig "project-admin/projectBuilds/project22/internal/handler/ApplicationConfig"
	Config "project-admin/projectBuilds/project22/internal/handler/Config"
	Doc "project-admin/projectBuilds/project22/internal/handler/Doc"
	DocHistory "project-admin/projectBuilds/project22/internal/handler/DocHistory"
	Group "project-admin/projectBuilds/project22/internal/handler/Group"
	GroupGroupRelation "project-admin/projectBuilds/project22/internal/handler/GroupGroupRelation"
	Project "project-admin/projectBuilds/project22/internal/handler/Project"
	UserGroup "project-admin/projectBuilds/project22/internal/handler/UserGroup"
