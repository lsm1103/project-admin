...
import (
	...
	Application "project-admin/projectBuilds/project24/internal/handler/Application"
	ApplicationInfo "project-admin/projectBuilds/project24/internal/handler/ApplicationInfo"
	Config "project-admin/projectBuilds/project24/internal/handler/Config"
	Doc "project-admin/projectBuilds/project24/internal/handler/Doc"
	DocHistory "project-admin/projectBuilds/project24/internal/handler/DocHistory"
	Group "project-admin/projectBuilds/project24/internal/handler/Group"
	GroupGroupRelation "project-admin/projectBuilds/project24/internal/handler/GroupGroupRelation"
	Project "project-admin/projectBuilds/project24/internal/handler/Project"
	UserGroup "project-admin/projectBuilds/project24/internal/handler/UserGroup"
