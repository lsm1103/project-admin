...
import (
	...
	"project-admin/projectBuilds/project-24/internal/logic/ApplicationInfo"
...
func CreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateApplicationInfoReq
		...
		l := ApplicationInfo.NewCreateLogic(r.Context(), svcCtx)
