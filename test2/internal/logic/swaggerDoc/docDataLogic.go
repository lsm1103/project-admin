...
func (l *DocDataLogic) DocData() (interface{}, error) {
	//path, _ := os.Getwd()
	//buf, err := Read2Byte("/Users/xm/Desktop/go_package/project-admin/projectBuilds/project4/swagger.json")
	buf, err := Read2Byte("/Users/xm/Desktop/go_package/project-admin/project-admin/swagger.json")
	if err != nil {
		return "获取数据失败", err
	}
