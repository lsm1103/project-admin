<script>
    ...
    function save() {
        ...
        request
            .then((result) => {
                ...
                hide();
                addSuccessToast(
                    collection.isNew ? "成功创建了集合" : "成功更新了集合"
                );
    ...
    function deleteConfirm() {
        ...
        confirm(`你真的要删除集合"${original?.name}"和它的所有记录吗`, () => {
...
>
    ...
    <svelte:fragment slot="footer">
        ...
        >
            <span class="txt">{collection.isNew ? "创建" : "保存更改"}</span>
        </button>
    </svelte:fragment>
</OverlayPanel>
