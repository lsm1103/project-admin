  ...
  <div class="gva-table-box">
    ...
    <el-table
      ...
      <el-table-column prop="id" label="主键" min-width="60" :show-overflow-tooltip=" true" align="center"/>
            <el-table-column prop="name" label="文档标题" min-width="100" align="center" :show-overflow-tooltip=" true"/>
<el-table-column
      ...
      <el-table-column prop="content" label="文档内容" min-width="100" align="center" :show-overflow-tooltip=" true"/>
      <el-table-column prop="parent_doc" label="上级文档" min-width="80" align="center" />
      <el-table-column prop="group_id" label="所属文档组" min-width="80" align="center" />
      <el-table-column prop="sort" label="排序" min-width="80" align="center" />
      <el-table-column prop="editor_mode" label="编辑器模式" min-width="80" align="center" />
      <el-table-column prop="open_children" label="展开下级目录" min-width="80" align="center" />
      <el-table-column prop="show_children" label="显示下级文档" min-width="80" align="center" />
    ...
    <el-dialog v-model="dialogFormVisible" :show-close="false" width="40%" >
      ...
      <el-form :model="formData" :rules="rules" label-width="80px">
          <!--机器生成，请勿修改-->
                  <el-form-item label="文档标题" prop="name" :show-overflow-tooltip="true">
        ...
        <el-form-item label="文档内容" prop="content" :show-overflow-tooltip="true">
          <el-input v-model="formData.content" autocomplete="off" />
        </el-form-item>
        <el-form-item label="上级文档" prop="parent_doc" min-width="100">
          <el-input-number v-model="formData.parent_doc" autocomplete="off" />
        </el-form-item>
        <el-form-item label="所属文档组" prop="group_id" min-width="100">
          <el-input-number v-model="formData.group_id" autocomplete="off" />
        </el-form-item>
        <el-form-item label="排序" prop="sort" min-width="100">
          <el-input-number v-model="formData.sort" autocomplete="off" />
        </el-form-item>
        <el-form-item label="编辑器模式" prop="editor_mode" min-width="100">
          <el-input-number v-model="formData.editor_mode" autocomplete="off" />
        </el-form-item>
        <el-form-item label="展开下级目录" prop="open_children" min-width="100">
          <el-input-number v-model="formData.open_children" autocomplete="off" />
        </el-form-item>
        <el-form-item label="显示下级文档" prop="show_children" min-width="100">
          <el-input-number v-model="formData.show_children" autocomplete="off" />
        </el-form-item>
