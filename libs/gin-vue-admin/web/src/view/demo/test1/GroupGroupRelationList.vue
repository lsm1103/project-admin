<template>
  <div class="gva-table-box">
    ...
    <el-table
      ...
      <el-table-column prop="master_group_id" label="主组id" min-width="80" align="center" />
      <el-table-column prop="from_group_id" label="从组id" min-width="80" align="center" />
      <el-table-column prop="relation" label="关系" min-width="80" align="center" />
    ...
    <el-dialog v-model="dialogFormVisible" :show-close="false" width="40%" >
      ...
      <el-form :model="formData" :rules="rules" label-width="80px">
        ...
        <el-form-item label="主组id" prop="master_group_id" min-width="100">
          <el-input-number v-model="formData.master_group_id" autocomplete="off" />
        </el-form-item>
        <el-form-item label="从组id" prop="from_group_id" min-width="100">
          <el-input-number v-model="formData.from_group_id" autocomplete="off" />
        </el-form-item>
        <el-form-item label="关系" prop="relation" min-width="100">
          <el-input-number v-model="formData.relation" autocomplete="off" />
        </el-form-item>
...
const getList = async (val) => {
  ...
  let res = await service({
    url: '/admin/GroupGroupRelation/v1/gets',
    method: 'post',
    data:val
  })
  if (res.code === 200) {
...
const add = (val) => {
  ...
  return service({
    url: '/admin/GroupGroupRelation/v1/',
    method: 'post',
    data:val
  })
}
