  ...
  <div class="gva-table-box">
    ...
    <el-table
      ...
      <el-table-column
          ...
          prop="user_id" label="用户id" min-width="80" align="center" />
      <el-table-column prop="key" label="key" min-width="100" align="center" :show-overflow-tooltip=" true"/>
      <el-table-column prop="value" label="value" min-width="100" align="center" :show-overflow-tooltip=" true"/>
    ...
    <el-dialog v-model="dialogFormVisible" :show-close="false" width="40%" >
      ...
      <el-form :model="formData" :rules="rules" label-width="80px">
          <!--机器生成，请勿修改-->
                  <el-form-item label="用户id" prop="user_id" min-width="100">
          <el-input-number v-model="formData.user_id" autocomplete="off" />
        </el-form-item>
        <el-form-item label="key" prop="key" :show-overflow-tooltip="true">
          <el-input v-model="formData.key" autocomplete="off" />
        </el-form-item>
        <el-form-item label="value" prop="value" :show-overflow-tooltip="true">
