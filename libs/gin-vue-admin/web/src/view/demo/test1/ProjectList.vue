  ...
  <div class="gva-table-box">
    ...
    <el-table
      ...
      <el-table-column prop="id" label="主键" min-width="60" :show-overflow-tooltip=" true" align="center"/>
            <el-table-column prop="name" label="名称" min-width="100" align="center" :show-overflow-tooltip=" true"/>
      ...
      <el-table-column prop="project_type" label="类型" min-width="80" align="center" />
<el-table-column
    ...
    <el-dialog v-model="dialogFormVisible" :show-close="false" width="40%" >
      ...
      <el-form :model="formData" :rules="rules" label-width="80px">
          <!--机器生成，请勿修改-->
                  <el-form-item label="名称" prop="name" :show-overflow-tooltip="true">
        ...
        <el-form-item label="类型" prop="project_type" min-width="100">
          <el-input-number v-model="formData.project_type" autocomplete="off" />
        </el-form-item>
