<template>
  <div class="gva-table-box">
    ...
    <el-table
      ...
      <el-table-column prop="group_id" label="组id" min-width="80" align="center" />
    ...
    <el-dialog v-model="dialogFormVisible" :show-close="false" width="40%" >
      ...
      <el-form :model="formData" :rules="rules" label-width="80px">
        ...
        <el-form-item label="组id" prop="group_id" min-width="100">
