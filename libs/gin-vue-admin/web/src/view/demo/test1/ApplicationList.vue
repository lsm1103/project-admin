  ...
  <div class="gva-table-box">
    ...
    <el-table
      ...
      <el-table-column prop="id" label="主键" min-width="60" :show-overflow-tooltip=" true" align="center"/>
            <el-table-column prop="zh_name" label="中文名称" min-width="100" align="center" :show-overflow-tooltip=" true"/>
      <el-table-column prop="en_name" label="英文名称" min-width="100" align="center" :show-overflow-tooltip=" true"/>
      <el-table-column prop="ico" label="图标" min-width="100" align="center" :show-overflow-tooltip=" true"/>
      <el-table-column prop="info" label="简介" min-width="100" align="center" :show-overflow-tooltip=" true"/>
<el-table-column
          column-key="create_user"
          :filters="nameList"
          :filter-method="filterHandler"
          prop="create_user" label="创建者id" min-width="80" align="center" />
      <el-table-column prop="demand_ids" label="需求组ids" min-width="100" align="center" :show-overflow-tooltip=" true"/>
      <el-table-column prop="doc_ids" label="文档组ids" min-width="100" align="center" :show-overflow-tooltip=" true"/>
      <el-table-column prop="join_users" label="参与者ids" min-width="100" align="center" :show-overflow-tooltip=" true"/>
      <el-table-column prop="join_groups" label="参与组ids" min-width="100" align="center" :show-overflow-tooltip=" true"/>
      <el-table-column prop="project_id" label="所属项目id" min-width="100" align="center" :show-overflow-tooltip=" true"/>
      <el-table-column prop="remark" label="备注" min-width="100" align="center" :show-overflow-tooltip=" true"/>
      <el-table-column prop="rank" label="排序" min-width="80" align="center" />
    ...
    <el-dialog v-model="dialogFormVisible" :show-close="false" width="40%" >
      ...
      <el-form :model="formData" :rules="rules" label-width="80px">
          <!--机器生成，请勿修改-->
                  <el-form-item label="中文名称" prop="zh_name" :show-overflow-tooltip="true">
          <el-input v-model="formData.zh_name" autocomplete="off" />
        </el-form-item>
        <el-form-item label="英文名称" prop="en_name" :show-overflow-tooltip="true">
          <el-input v-model="formData.en_name" autocomplete="off" />
        </el-form-item>
        <el-form-item label="图标" prop="ico" :show-overflow-tooltip="true">
        ...
        <el-form-item label="需求组ids" prop="demand_ids" :show-overflow-tooltip="true">
          <el-input v-model="formData.demand_ids" autocomplete="off" />
        </el-form-item>
        <el-form-item label="文档组ids" prop="doc_ids" :show-overflow-tooltip="true">
        ...
        <el-form-item label="参与组ids" prop="join_groups" :show-overflow-tooltip="true">
          <el-input v-model="formData.join_groups" autocomplete="off" />
        </el-form-item>
        <el-form-item label="所属项目id" prop="project_id" :show-overflow-tooltip="true">
