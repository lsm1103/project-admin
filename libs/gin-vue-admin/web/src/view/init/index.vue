<template>
  <div class="init_page">
    <div class="init_page_panel">
      <div v-if="!startInit" id="hello" :class="[!startInit ? 'slide-in-fwd-top' : 'slide-out-right']" class="hello">
        <div>
      ...
      <div v-if="startInit" :class="[(startInit && !out)? 'slide-in-left' : '' , out ? 'slide-out-right' : '']" class="form">
