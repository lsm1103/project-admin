...
var (
	...
	groupGroupRelationRowsExpectAutoSet   = strings.Join(stringx.Remove(groupGroupRelationFieldNames, "`created_at`", "`create_time`", "`update_at`", "`updated_at`", "`update_time`", "`create_at`"), ",")
