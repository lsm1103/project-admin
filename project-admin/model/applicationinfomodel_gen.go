...
var (
	...
	applicationInfoRowsExpectAutoSet   = strings.Join(stringx.Remove(applicationInfoFieldNames, "`updated_at`", "`update_time`", "`create_at`", "`created_at`", "`create_time`", "`update_at`", "`state`"), ",")
	applicationInfoRowsWithPlaceHolder = strings.Join(stringx.Remove(applicationInfoFieldNames, "`id`", "`updated_at`", "`update_time`", "`create_at`", "`created_at`", "`create_time`", "`update_at`"), "=?,") + "=?"
